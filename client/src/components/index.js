...
export {default as TeacherRegister} from './teacher/teacher_register/teacherRegister.js';
export {default as TeacherDash} from './teacher/teacher_dash/teacherDash.js';
